/* ================================================
   MERI DUKAAN v8.0 — ICONS
   Inline SVG icon system — no CDN, 100% offline
   Usage: getIcon('home', 20, '#fff')
   ================================================ */
...
var ICONS = {
  ...
  more:       '<line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="18" x2="21" y2="18"/>',
  ...
  'trend-dn': '<polyline points="23 18 13.5 8.5 8.5 13.5 1 6"/><polyline points="17 18 23 18 23 12"/>',
  ...
  cash:       '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 1 0 0 7h5a3.5 3.5 0 1 1 0 7H6"/>',
  wallet:     '<path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4z"/>',
  phone:      '<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.77 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 8.91a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>',
...
/**
 * getIcon(name, size, color, strokeWidth)
 ...
 */
function getIcon(name, size, color, strokeWidth) {
    var path  = ICONS[name];
    if (!path) { console.warn('[Icons] Unknown icon:', name); return ''; }
    var sz    = size || 20;
...
/**
 * setIcon(elementId, name, size, color)
 * Injects icon SVG into a DOM element.
 */
function setIcon(elementId, name, size, color) {
    var el = document.getElementById(elementId);
    if (el) el.innerHTML = getIcon(name, size, color);
}

/**
 * renderIcons()
 * Auto-renders all elements with data-icon attribute.
 * <span data-icon="home" data-size="20" data-color="#fff"></span>
 */
function renderIcons() {
    document.querySelectorAll('[data-icon]').forEach(function(el) {
        ...
        var sw    = parseFloat(el.getAttribute('data-sw')  || '1.75');
        el.innerHTML = getIcon(name, size, color, sw);
    });
}
...
console.log('[Icons] Meri Dukaan v8.0 — ' + Object.keys(ICONS).length + ' icons loaded');
